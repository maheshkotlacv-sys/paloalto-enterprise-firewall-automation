...
variable "mgmt_security_group_id" { type = string }
variable "data_security_group_id" { type = string }
variable "ha_security_group_id"   { type = string }
variable "bootstrap_s3_bucket"    { type = string }
variable "bootstrap_iam_role_arn" { type = string }
variable "ha_role"                { type = string; default = "primary" }
